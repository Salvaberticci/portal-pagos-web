...
switch (true) {
    ...
    case preg_match('#^clientes/([^/]+)/perfil/?$#', $uri) === 1 && $method === 'GET':
        ...
        mock_json([
            ...
            'data' => [
                ...
                'email_facturacion'       => '',
                'regimen_tributacion'     => 0,
                'giro'                    => '',
                'cedula_facturacion'      => '',
                'informacion_adicional'   => '',
                'retenciones'             => 0.00,
                'numeracion_alterna'      => false,
    ...
    // GET /clientes/{id}/  (detalle del servicio con zona, plan_internet, estado)
    case preg_match('#^clientes/([^/]+)/?$#', $uri) === 1 && $method === 'GET':
        ...
        mock_json([
            ...
            'data' => [
                ...
                'forma_contratacion'      => 'recomendacion',
                ...
                'sectorial'               => ['id' => 1, 'nombre' => 'Sectorial Norte'],
                'modelo_antena'           => ['id' => 1, 'nombre' => 'Antena 5GHz'],
                'plan_internet'           => ['id' => 1, 'nombre' => 'Plan Básico 20MB'],
                'asesor'                  => ['id' => 1, 'nombre' => 'Asesor Principal'],
                'tecnico'                 => ['id' => 1, 'nombre' => 'Técnico Principal'],
            ],
        ]);
